...
class UsrVsUsrStartGame extends StatefulWidget {
  final String player1Name;
  final String player2Name;
  const UsrVsUsrStartGame(
      {required this.player1Name, required this.player2Name, Key? key})
      : super(key: key);
  @override
  State<UsrVsUsrStartGame> createState() => _UsrVsUsrStartGameState();
}

class _UsrVsUsrStartGameState extends State<UsrVsUsrStartGame> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Player 1 Container (player1TWin Widget) Widget
    ...
    // Player 2 Container (player2tWin Widget) Widget
    ...
    String lottiePlayer2 = 'assets/player.json';
    ...
    void clickFun(String gridNum) {
      ...
      CurrTurn++;
      if (GameCode().areGridFilled(gridListSym) && !GameCode().isGameWonBool(gridListSym)) {
        showDialog(
            context: context,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          height: 70,
                          width: 70,
                          child: player1Light ? LottieBuilder.asset('$lottiePlayer1',reverse: true, repeat: true,):LottieBuilder.asset('$lottiePlayer1',reverse: true, repeat: false,)
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          height: 70,
                          width: 70,
                          child: player1Light ? LottieBuilder.asset('$lottiePlayer2',reverse: true):LottieBuilder.asset('$lottiePlayer2',repeat: false,)
                        ),
                      ),
